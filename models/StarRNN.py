...
class StarRNN(torch.nn.Module):
    def __init__(self, input_dim=13, num_classes=9, hidden_dims=128, num_layers=3, dropout=0.5, bidirectional=False, use_batchnorm=False, use_layernorm=True, device=torch.device("cpu")):
